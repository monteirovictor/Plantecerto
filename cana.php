...
<nav>
  <div class="nav-wrapper green darken-2">
    ...
    <ul id="nav-mobile" class="right hide-on-med-and-down">
      <li><a href="mediacana.php">Média</a></li>
      <li><a href="canatemperatura.php">Gráfico Temperatura</a></li>
      <li><a href="canaumidade.php">Gráfico Umidade</a></li>
      <li><a href="canalux.php">Gráfico Luminosidade</a></li>
