...
<nav>
  <div class="nav-wrapper green darken-2">
    ...
    <ul id="nav-mobile" class="right hide-on-med-and-down">
      <li><a href="mediamelancia.php">Média</a></li>
      <li><a href="melanciatemperatura.php">Gráfico Temperatura</a></li>
      <li><a href="melanciaumidade.php">Gráfico Umidade</a></li>
      <li><a href="melancialux.php">Gráfico Luminosidade</a></li>
